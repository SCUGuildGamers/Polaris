...
public class Plastic : MonoBehaviour
{
    ...
    // Determines how often a reflectable plastic spawns where the chance is 1/_reflectableChance
    private int _reflectableChance = 4;
    ...
    // Changes the target to the source of the plastic
    ...
    // Reverse the target direction by a factor of -1
